...
class DailyChartBuild extends StatelessWidget {
  final MeteoEntity data;

  const DailyChartBuild({super.key, required this.data});

  @override
  Widget build(BuildContext context) {
    final bool isMetric = context.read<MetricCubit>().isMetric;
    final spots = spotsDataDaily(data);
    final time = spotsDays(data);
