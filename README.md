...
| Маршрутизация         | go_router ^14.0.0                                                    |
| HTTP клиент           | Dio ^5.9.2                                                           |
| Геолокация            | geolocator ^14.0.2                                                   |
| Локальное хранилище   | shared_preferences ^2.5.5, path_provider ^2.1.5                      |
| Часовые пояса         | flutter_native_timezone_2025 ^1.0.0                                  |
| Графики               | fl_chart ^1.2.0                                                      |
| Иконки                | font_awesome_flutter ^11.0.0, cupertino_icons ^1.0.8                 |
| Интернационализация   | intl ^0.19.0                                                         |
| Индикаторы страниц    | smooth_page_indicator ^1.1.0                                         |
| Проверка интернета    | internet_connection_checker ^3.0.1                                   |
| Утилиты               | equatable ^2.0.8, dartz ^0.10.1, get_it ^9.2.1                       |
| Тестирование          | flutter_test, bloc_test ^10.0.0, mockito ^5.4.0, build_runner ^2.4.6 |
